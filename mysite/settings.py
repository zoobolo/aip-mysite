...
SECRET_KEY = 'w3+o6tnfime6zkx3$l@ecw=$(c^-v7kanx=#1e32$@ctd04$np'
...
#        'DIRS': ['/home/ubuntu/workspace/grant/templates'],
        'DIRS': ['/home/ubuntu/workspace/grant/templates/grant'],
#        'DIRS': [],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
